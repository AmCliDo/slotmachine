...
state = {
    ...
    "spinning": False          # <— NEU: zeigt „Runde läuft“ an
}
...
def play_once(source="button"):
    ...
    # 2) LEDs 2 s blinken lassen (Startsignal) – außerhalb des Locks
    ...
    time.sleep(2.0)  # Sichtbare Drehzeit für die Web-Animation
...
def setup_gpio():
    global btn_add, btn_play, led_green, led_red
    ...
    try:
        ...
        # Taster lösen dieselben Aktionen aus wie die Web-Buttons
